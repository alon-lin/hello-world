...
layui.use(['form','layer','laypage','table','laydate'],function(){
	...
	$.ajax({
		...
		success:function(mydata){
			   $("#rcard").val(mydata.rcard);
			   $("#rname").val(mydata.rname);
			   $("#img").val(mydata.img);
			   $("#rtel").val(mydata.rtel);
			   $("#rpsw").val(mydata.rpsw);
			   $("#rsex").val(mydata.rsex);
			   $("#did").val(mydata.did);
			   $("#rbirthday").val(mydata.rbirthday);
			   $("#rstatus").val(mydata.rstatus);
			   $("#rmoney").val(mydata.rmoney);
			   $("#rjf").val(mydata.rjf);
			   $("#rcarnum").val(mydata.rcarnum);
			   $("#aid").val(mydata.aid);
			   $("#xid").val(mydata.xid);
			   $("#rcolor").val(mydata.rcolor);
			   $("#rway").val(mydata.rway);
			   $("#zid").val(mydata.zid);
			   $("#rnum").val(mydata.rnum);
			   $("#raddress").val(mydata.raddress);
			   $("#rtime").val(mydata.rtime);
			   $("#rremark").val(mydata.rremark);
		}
