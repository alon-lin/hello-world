...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/youhui/add.js"></script>
<style type="text/css">
				...
				<td>
					  <div class="layui-form-item layui-form-text">
					    ...
					    <div class="layui-input-block">
					      <textarea placeholder="请输入内容" class="layui-textarea"  id="ytitle" lay-verify="required" style = "width:300px;"></textarea>
					    </div>
					  </div>
				</td>
			</tr>
