	...
	<table class="layui-table"
		...
		<thead>
			<tr>
				...
				<th lay-data="{field:'fimg',templet: '#xx'}">员图片</th>
				<th lay-data="{field:'fcount'}">库存数量</th>
				<th
					lay-data="{fixed: 'right', width:178, align:'center', toolbar: '#barDemo'}">入库操作</th>
					<th
					lay-data="{fixed: 'right', width:178, align:'center', toolbar: '#barDemo2'}">出库操作</th>
			</tr>
		</thead>
	</table>
...
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" lay-event="out" >入库记录</a>
</script>
<script type="text/html" id="barDemo2">
  <a class="layui-btn layui-btn-xs" lay-event="up" >出库记录</a>
</script>
</body>
</html>